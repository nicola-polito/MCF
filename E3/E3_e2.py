...
plt.scatter(df_fsrq['nu_syn'], df_fsrq['PL_Index'], color= 'darkslategray', s= 12, label='fsrq', alpha = 0.8)
...
plt.savefig('PL_Index_bll-fsrq.png')
plt.legend()
plt.show()
...
plt.title('for fsrq and bll source class')
plt.suptitle('Spectral Index in function of Log(nu_syn)')
plt.savefig('PL_Index_bll-fsrq1.png')
plt.legend()
plt.show()
...
plt.savefig('hist_PL_Index_bll-fsrq1.png')
...
plt.xlabel('Log(nu_syn) [Hz]', fontsize=10)
plt.ylabel('Numbers of sources', fontsize=10)
plt.savefig('hist_log_PL_Index_bll-fsrq1.png')
plt.legend(fontsize=10)
plt.show()